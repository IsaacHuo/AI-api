export default {
  ...
  setup: {
    title: 'GPT AI Setup',
    description: 'Configure your GPT AI instance',
    database: {
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. gpt-ai-backups), choose a region',
    ...
    accounts: {
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another GPT AI instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for GPT AI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for GPT AI end-user login',
