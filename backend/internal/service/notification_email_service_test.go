...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "GPT AI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "GPT AI", "https://example.com/reset", "en-US"))
